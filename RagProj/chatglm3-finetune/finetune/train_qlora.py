...
def parse_args():
    parser = argparse.ArgumentParser(description='chatglm3-6b QLoRA')
    parser.add_argument('--train_args_json', type=str, default="./chatglm3-6b_QLoRA.json", help='TrainingArguments的json文件')
